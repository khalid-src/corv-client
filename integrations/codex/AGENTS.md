# Corv - remote commands over SSH

This project uses Corv, a local SSH client, to run commands on remote
machines. Machines are saved by name; run commands by name and never handle
credentials directly.

## Discover

`corv list` - show saved connection names. Never guess a name; list first.
